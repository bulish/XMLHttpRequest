...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"gsap.js":[function(require,module,exports) {
/**
...
var buttonsFunction = function buttonsFunction() {
  // mouseenter event
  var mouseEnterFunction = function mouseEnterFunction(e) {
    var x = window.getComputedStyle(e.target).getPropertyValue('background-color');
    ...
    if (x === 'rgb(255, 255, 255)') {
      gsap.to(e.target, {
        backgroundColor: 'rgb(231, 220, 220)',
        duration: .5,
        scale: 1.05
      });
    }
  ...
  var mouseLeaveFunction = function mouseLeaveFunction(e) {
    var x = window.getComputedStyle(e.target).getPropertyValue('background-color');
...
},{}]},{},["../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","gsap.js"], null)
//# sourceMappingURL=/gsap.213eed97.js.map